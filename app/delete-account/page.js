...
export default function DeleteAccount() {
  ...
  const t = {
    fr: {
      ...
      lead:
        "Voici comment demander la suppression définitive de votre compte MathHero.",
      ...
      helpText:
        "Envoyez-nous une demande par e-mail à l’adresse ci-dessous en indiquant votre pseudo et, si possible, l’e-mail lié au compte.",
      mail: "Demander la suppression par e-mail",
      legal:
        "La suppression est irréversible. Les données transitent chiffrées et ne sont pas revendues. Pour toute question, contactez-nous.",
    },
    en: {
      ...
      helpText:
        "Send us a request by e-mail with your username and, if possible, the e-mail linked to the account.",
      mail: "Request deletion by e-mail",
      legal:
        "Deletion is irreversible. Data is transmitted over encrypted connections and is not sold. For any question, contact us.",
    },
  }[lang];

  const mailto =
    "mailto:support@mathhero.dev" +
    "?subject=" +
    encodeURIComponent(
      lang === "fr"
        ? "Suppression de compte MathHero"
        : "MathHero account deletion"
    ) +
    "&body=" +
    encodeURIComponent(
      lang === "fr"
